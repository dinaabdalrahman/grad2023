...
class Adding_Patient extends StatefulWidget{

  @override
  State<StatefulWidget> createState() {
    return Adding_PatientState ();

  }
}

class  Adding_PatientState extends State<Adding_Patient> {
  File? imageFile;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Center(child: Text("   Adding Patients        ", style: TextStyle(
        ...
        SizedBox(height: 20),
              ...
              Center(
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).pushNamed("after add patient");
                  },
