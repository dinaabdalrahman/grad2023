...
class After_Add_doctor extends StatefulWidget{

  @override
  State<StatefulWidget> createState() {
    return After_Add_doctorState ();

  }
}
class  After_Add_doctorState extends State<After_Add_doctor> {
  var selectedindex =2;
  int favorite=0;
                      ...
                      Expanded( flex: 3,
                        child: Column(
                          children: [ListTile(title: Text(_foundDoctor[index]['name']),
                              ...
                              subtitle:Row(children: [Icon(Icons.star_half_outlined,color: Colors.blue,),
                                Text(_foundDoctor[index]['reviews']),IconButton(
