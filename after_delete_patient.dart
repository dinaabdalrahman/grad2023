...
class Delete_patient extends StatefulWidget{

  @override
  State<StatefulWidget> createState() {
    return  Delete_patientState ();
  }
}
class   Delete_patientState extends State<Delete_patient> {
  int selectedindex=2;
  List patientdata =[
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton:FloatingActionButton.extended(
          ...
          heroTag: 'uniqueTag',
          onPressed: () {
            Navigator.of(context).pushNamed("adding patient");
